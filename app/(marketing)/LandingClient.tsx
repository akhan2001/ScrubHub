...
const LISTINGS = [
  {
    id: 1,
    title: "Maple Walk Studio",
    address: "Cabbagetown · 0.6 km to Sherbourne Hospital",
    price: 2840,
    beds: 1,
    baths: 1,
    sqft: 540,
  ...
  {
    id: 2,
    title: "Riverside Loft 4B",
    address: "King West · 1.2 km to Toronto Western",
    price: 3210,
    beds: 2,
    baths: 1,
    sqft: 720,
  ...
  {
    id: 3,
    title: "The Beaches Suite",
    address: "Beaches · 0.9 km to Michael Garron",
    price: 2640,
    beds: 1,
    baths: 1,
    sqft: 480,
  ...
  {
    id: 4,
    title: "Lakeshore Pied-à-terre",
    address: "Mimico · 1.4 km to Trillium Health",
    price: 2990,
    beds: 1,
    baths: 1,
    sqft: 610,
  ...
  {
    id: 5,
    title: "Annex Townhouse",
    address: "The Annex · 0.4 km to Toronto General",
    price: 3680,
    beds: 2,
    baths: 2,
    sqft: 880,
  ...
  {
    id: 6,
    title: "Riverdale Garden",
    address: "Riverdale · 1.0 km to Bridgepoint Health",
    price: 2510,
    beds: 1,
    baths: 1,
    sqft: 520,
...
function Eyebrow({
  ...
  return (
    <div
      className={`font-mono text-[11px] tracking-[0.18em] uppercase text-[#6B7585] font-medium ${className}`}
    >
      {children}
    </div>
  );
      ...
      <div className="mx-auto max-w-[1320px] px-8">
        ...
        <div className="max-w-[920px] mb-9">
          ...
          >
            ...
            <br />
            <span
              className="font-serif italic font-normal text-[#1E5BBE]"
          ...
          <p className="max-w-[560px] mt-5 text-lg leading-snug text-[#3A4759]">
            Furnished homes, clinical suites, and locum roles within walking
            distance of Ontario’s top hospitals. Vetted hosts. No-broker fees.
            Move-in tonight.
          </p>
        </div>
        ...
        <div className="relative">
          <div
            className="relative overflow-hidden rounded-[28px] bg-gradient-to-br from-[#0E1A2B] to-[#1a3a5c]"
            style={{ aspectRatio: "21/9", minHeight: 420, maxHeight: 560 }}
          >
            <img
              src="https://images.unsplash.com/photo-1605276373954-0c4a0dac5b12?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt=""
        ...
        <div className="mt-9 grid grid-cols-2 sm:grid-cols-4 gap-6 pt-8 border-t border-[#E5DFD2]">
          {[
            ...
            <div key={l}>
              <div
                className="font-medium tracking-[-0.04em] text-[#0E1A2B]"
                style={{ fontSize: 42 }}
              >
                {n}
              </div>
      ...
      <div className="mx-auto max-w-[1320px] px-8">
        <div className="flex items-end justify-between mb-9 flex-wrap gap-5">
          <div>
            ...
            <h2
              className="m-0 font-medium tracking-[-0.04em] leading-[0.96]"
              style={{ fontSize: "clamp(36px, 4.6vw, 56px)" }}
            >
              Hand-picked stays
              <br />
              <span
                className="italic font-normal text-[#1E5BBE]"
                style={{ fontFamily: '"Instrument Serif", Georgia, serif' }}
              >
                near every shift.
              </span>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => scroll(-1)}
              className="size-11 rounded-full border border-[#E5DFD2] grid place-items-center hover:border-[#0E1A2B] transition"
            >
            ...
            <Link
              href="/facility-map"
              className="ml-2 inline-flex items-center gap-2 h-11 px-5 rounded-full border border-[#E5DFD2] text-sm font-semibold hover:border-[#0E1A2B] transition"
            >
        ...
        >
          {LISTINGS.map((l) => (
            <article
              key={l.id}
              className="snap-start flex flex-col gap-3.5 transition-transform duration-300 hover:-translate-y-1"
            >
              <div
                className="relative rounded-2xl overflow-hidden bg-[#EFE9DD]"
                style={{ aspectRatio: "4/5" }}
              >
                <div
                  className="absolute inset-0 flex items-center justify-center font-mono text-[11px] tracking-[0.12em] uppercase text-[#6B7585]"
                  style={{
                    background:
                      "repeating-linear-gradient(135deg, #F0EBDF 0 12px, #EFE9DD 12px 24px)",
                  }}
                >
                  <span className="px-2.5 py-1.5 bg-white/70 rounded-md">
                    interior · {l.title}
                  </span>
                </div>
              ...
              <div>
                <div className="flex justify-between items-baseline gap-3">
                  <h3 className="text-lg font-semibold m-0 tracking-[-0.015em]">
                    {l.title}
                  </h3>
                  <span className="text-lg font-semibold tracking-[-0.02em]">
                    ${l.price.toLocaleString()}
                    <span className="text-[13px] font-normal text-[#6B7585]">
                      /mo
                    </span>
                  </span>
                </div>
                ...
                <div className="flex gap-4.5 text-[13px] text-[#3A4759]">
                  <span className="inline-flex items-center gap-1.5">
                    <Bed className="size-4" /> {l.beds} bed
                  </span>
                  <span className="inline-flex items-center gap-1.5">
                    <Bath className="size-4" /> {l.baths} bath
                  </span>
                  <span className="inline-flex items-center gap-1.5">
                    <Square className="size-4" /> {l.sqft} sqft
                  </span>
                </div>
              </div>
            </article>
        ...
        <div className="grid lg:grid-cols-[1fr_1.15fr] gap-16 items-center">
          <div>
            ...
            <p className="mt-5 max-w-[520px] text-lg leading-[1.55] text-[#3A4759]">
              From Windsor to Kingston, ScrubHub maps 500+ clinical hubs — with
              walk-times, transit overlays, and live availability for every
              furnished unit on the route.
            </p>

            <div className="flex flex-col gap-3.5 mt-7 mb-8">
              {[
                [
                  "Walk-time to facility",
                  "Filter by minutes from any hospital entrance",
                ],
                [
                  "Transit overlay",
                  "GO Transit, TTC, MiWay layered on the map",
                ],
                [
                  "Verified inventory",
                  "Every host meets ScrubHub housing protocol",
                ],
              ].map(([h, s]) => (
                <div
                  key={h}
                  className="flex gap-3.5 pb-3.5 border-b border-[#E5DFD2]"
                >
            ...
            <Link
              href="/facility-map"
              className="inline-flex items-center gap-2 h-12 px-6 rounded-full bg-[#0E1A2B] hover:bg-[#1a2a3f] text-white font-semibold transition"
            >
          ...
          <div
            className="relative rounded-3xl overflow-hidden bg-white border border-[#E5DFD2] shadow-[0_30px_60px_rgba(14,26,43,0.10)]"
          ...
          >
            ...
            <div className="absolute bottom-4 right-5 inline-flex gap-3.5 items-center rounded-full bg-white/90 backdrop-blur px-3 py-1.5">
              <span className="inline-flex items-center gap-1.5">
                ...
                <span className="font-mono text-[10px] tracking-[0.14em] uppercase text-[#3A4759]">
                  Hospitals
                </span>
              </span>
              <span className="inline-flex items-center gap-1.5">
...
function HowItWorks() {
  const steps: [string, string, string][] = [
    [
      "01",
      "Search by hospital",
      "Pick your facility and shift dates — we surface only listings within a 15-minute walk or transit hop.",
    ],
    [
      "02",
      "Verify, then book",
      "Hosts are credentialed against the ScrubHub housing protocol. License upload, e-sign, deposit — all in one flow.",
    ],
    [
      "03",
      "Move in tonight",
      "Lockbox or smart-lock access. Concierge LIAISON on standby for late shifts and last-minute swaps.",
    ],
  ];
  return (
      ...
      <div className="mx-auto max-w-[1320px] px-8">
        <div className="grid lg:grid-cols-[1fr_2fr] gap-12 mb-12 items-end">
          ...
          <p className="text-[17px] leading-[1.55] text-[#3A4759] max-w-[540px] m-0 lg:justify-self-end">
            We rebuilt the rental flow for the rhythm of clinical work — nights,
            swaps, and 13-week contracts that don’t fit a 12-month lease.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#E5DFD2] border border-[#E5DFD2] rounded-3xl overflow-hidden">
          {steps.map(([n, t, d]) => (
            <div
              key={n}
              className="bg-[#F7F4EE] p-9 flex flex-col gap-4 min-h-[280px]"
            >
              <div className="font-mono text-xs tracking-[0.18em] text-[#6B7585]">
                {n}
              </div>
              <h3
                className="m-0 italic font-normal text-[34px] leading-[1.05] tracking-[-0.01em] text-[#1E5BBE]"
                style={{ fontFamily: '"Instrument Serif", Georgia, serif' }}
              >
                {t}
              </h3>
              <p className="m-0 text-[15px] leading-[1.6] text-[#3A4759]">
                {d}
              </p>
            </div>
          ))}
      ...
      <div className="mx-auto max-w-[1320px] px-8">
        <div className="flex items-end justify-between mb-7 flex-wrap gap-5">
          <div>
            ...
            <h2
              className="m-0 font-medium tracking-[-0.04em] leading-[0.96]"
              style={{ fontSize: "clamp(32px, 3.8vw, 44px)" }}
            >
              Where to land
              <br />
              <span
          ...
          <Link
            href="/facility-map"
            className="text-sm font-semibold text-[#0E1A2B] inline-flex items-center gap-1.5 hover:gap-2 transition-all"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4.5">
          {NEIGHBORHOODS.map((n) => (
            <Link
              key={n.name}
              href="/facility-map"
              className="grid grid-cols-[1fr_auto] gap-4.5 items-center px-6 py-5 bg-white border border-[#E5DFD2] rounded-2xl no-underline text-[#0E1A2B] transition hover:border-[#0E1A2B] hover:-translate-y-0.5"
            >
              <div>
              ...
              <div className="text-right">
                <div className="font-medium tracking-[-0.03em] text-2xl">
                  {n.count}
                </div>
                <div className="font-mono text-[9px] tracking-[0.16em] uppercase text-[#6B7585]">
                  stays
                </div>
              </div>
            </Link>
...
function HostsCTA() {
  return (
    <section className="relative py-16 bg-[#0E1A2B] text-white overflow-hidden">
      <img
        src="https://images.unsplash.com/photo-1739761445204-fa7c0d501e92?w=2200&q=85&auto=format&fit=crop"
        alt=""
        aria-hidden
        className="absolute inset-0 w-full h-full object-cover"
      />
      <div className="absolute inset-0 bg-gradient-to-br from-[#0E1A2B]/95 via-[#0E1A2B]/90 to-[#0E1A2B]/85 pointer-events-none" />
      <div className="relative z-10 mx-auto max-w-[1320px] px-8 grid lg:grid-cols-[1.4fr_1fr] gap-12 items-center">
        <div>
          <div className="font-mono text-[11px] tracking-[0.18em] uppercase opacity-70 mb-4">
            For hosts &amp; landlords
          </div>
          <h2
            className="m-0 font-medium tracking-[-0.04em] leading-[0.96]"
          ...
          <p className="text-[17px] opacity-75 leading-[1.5] mt-4 max-w-[540px]">
            List once. ScrubHub matches you with credentialed practitioners on
            8–13 week contracts, handles deposits, and pays out within 48 hours
            of move-in.
          </p>
          <div className="flex gap-3 mt-7 flex-wrap">
            <Link
              href={getAppSignupUrl()}
              className="inline-flex items-center gap-2 h-13 px-6 rounded-full bg-[#F7F4EE] text-[#0E1A2B] font-semibold transition hover:-translate-y-0.5"
              style={{ height: 52 }}
            >
              List a unit <ArrowRight className="size-4" />
            </Link>
            <button
              className="inline-flex items-center h-13 px-6 rounded-full border border-white/30 text-white font-semibold transition hover:border-white/60"
              style={{ height: 52 }}
            >
              Talk to LIAISON
            </button>
        ...
        <div className="grid grid-cols-2 gap-3.5">
          {[
            ...
            <div
              key={l}
              className="px-5.5 py-5.5 rounded-2xl bg-white/8 border border-white/15"
              style={{ padding: "22px 22px" }}
            >
              <div className="font-medium tracking-[-0.03em] text-[32px]">
                {n}
              </div>
              <div className="font-mono text-[10px] tracking-[0.16em] uppercase opacity-70 mt-1.5">
                {l}
              </div>
            </div>
          ))}
    ...
    <div className="fixed bottom-6 right-6 z-50 w-[340px] rounded-2xl bg-white shadow-[0_24px_60px_rgba(14,26,43,0.22)] border border-[#E5DFD2] overflow-hidden">
      ...
      <div className="p-5 bg-[#F7F4EE]">
        <div className="bg-white border border-[#E5DFD2] rounded-xl p-3.5 text-sm text-[#3A4759]">
          Hi — looking for a stay near a specific hospital, or a locum role this
          rotation?
        </div>
      </div>
    </div>
