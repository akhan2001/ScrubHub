...
import { landlordIdentitySchema } from '@/lib/validations/onboarding';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import { z } from 'zod';

type FormData = z.infer<typeof landlordIdentitySchema>;

export function Step1Identity({ onNext }: { onNext: (data: FormData) => void }) {
  const {
    register,
    handleSubmit,
